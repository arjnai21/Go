    ...
    render() {
        return (
            <div className="App">
                <BrowserRouter>
                    <Switch>
                        <Route path={"/game"} render={(props) => <GamePage {...props} color={this.state.color}
                                                                           opponentName={this.state.opponentName}
                                                                           socket={this.state.socket}/>}/>
                        <Route path={"/lobby"}
                               render={(props) => <LobbyPage {...props} username={this.state.username} players={[""]}
                                                             inviteDialogOpen={false} setColor={this.setColor}
                                                             setOpponentName={this.setOpponentName}
                                                             socket={this.state.socket}/>}/>
                        <Route path={"/"} render={(props) => <NamePage {...props} previousName={this.state.username}
